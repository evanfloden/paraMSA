...
do 
  ...
  do
    ...
    cp /users/cn/jchang/projects/2010-03_ConM-Coffee/results/2013-03-26_bench-simulation/data/tips${tip}/symmetric_${sym}/${i}/seqs/${i}.0400.fa tips${tip}_${sym}/tips${tip}_${sym}_${i}.0400.fa
